...
For $i$ in ${0,1,2}$ let $A_i$ be a r.v. describing the event that Bobo turns into $i$ amoebas. It follows that
 ...
 3. $P(A|X_2) = P(X)^2$; Bobo has two offsprings. Both will retain its reproduction probabilities

By the law of total probability we can now write $P(X)$ as 
$$P(X) = \frac{1}{4} P(X|A_0) + \frac{1}{4} P(X|A_1) + \frac{1}{4} P(X|A_2)$$
...
ggplot(data=df, aes(x=as.factor(outcomes))) + geom_histogram() + xlab("outcomes")
```
